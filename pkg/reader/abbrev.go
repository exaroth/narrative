...
var (
	ABBREV_CASE_I = `\b(adj|asst|ave|bld|bldg|blvd|bros|btw|capt|cmdr|co|col|conn|corp|cpl|` +
		`dec|dept|dr|drs|e[.]g|eg|feb|ft|esq|gov|hon|hosp|hr|hrs|hway|` +
		`gen|hwy|i[.]e|ie|inc|insp|jan|jr|jul|lt|ltd|maj|mar|mass|may|md|` +
		`max|min|mr|mrs|ms|msgr|messrs|mmes|mses|miss|nebr|nev|no|nos|` +
		`nr|oct|ok|ph[.]d|phd|ny|penn|pls|prof|n[.]y|pvt|ref|rev|rep|sec|sep|` +
		`sept|sgt|sr|st|tenn|tex|univ|us|u[.]s|ver|vs|fig|brig|att|sen|adm` +
		`)\b([.]?)`
	ABBREV_CASE_I_RE = regexp.MustCompile(`(?i)` + ABBREV_CASE_I)

	ABBREV_CASE_S_RE = regexp.MustCompile(`\b(c[.]|s[.]|p[.])(\s|$)`)
)
...
var ABBREV_MAP = map[string]string{
	...
	"nr": "number", "oct": "october", "ok": "ok", "ph.d": "doctor of physics",
	"phd": "doctor of physics", "ny": "new york", "penn": "pennsylvania", "pls": "please",
	"prof": "professor", "n.y": "new york", "pvt": "private", "ref": "reference",
	"rev": "reverend", "rep": "representative", "sec": "second", "sep": "separate", "sept": "september",
	...
	"brig": "brigadier", "att": "attorney", "sen": "senator", "adm": "admiral",
